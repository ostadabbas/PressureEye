...
parser.add_argument('--efs_rt', type=float, default=0.,
...
for rstNm in rst_li:
    ...
    cnt = diff_vStk.shape[0] # how many images
    ...
    for i in trange(cnt):
        # diff_abs = diff_vStk[i*step:(i+1)*step]
        real_B = real_vStk[i]
        fake_B = fake_vStk[i]
        ...
        # print(pytorch_ssim.ssim(ts_real_B, ts_fake_B))
        # print('before ssim')
