...
#SBATCH --mem=100Gb
#SBATCH --output=bch_outs/openPose_RGB_clip01.%j.out
#SBATCH --error=bch_outs/openPose_RGB_clip01.%j.err
source activate pch1.5
# --dataroot /home/jun/datasets/SLP/danaLab
#python train.py --dataroot /scratch/liu.shu/datasets/SLP/danaLab \
python train.py --dataroot /home/jun/datasets/SLP/danaLab \
