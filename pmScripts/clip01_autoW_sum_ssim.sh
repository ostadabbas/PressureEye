...
#SBATCH --mem=100Gb
#SBATCH --output=bch_outs/vis2PM_RGB_clip01_autoW_sum_ssim.%j.out
#SBATCH --error=bch_outs/vis2PM_RGB_clip01_autoW_sum_ssim.%j.err
...
--type_whtL pwrs --lambda_sum 1e-6 --lambda_ssim 10 --lambda_D 0 \
