...
#SBATCH --mem=100Gb
#SBATCH --output=bch_outs/vis2PM_RGB_clip01_sum.%j.out
#SBATCH --error=bch_outs/vis2PM_RGB_clip01_sum.%j.err
...
--type_whtL n --lambda_sum 1e-6 --lambda_ssim 0 --lambda_D 0 \
