...
#SBATCH --mem=100Gb
#SBATCH --output=bch_outs/vis2PM_RGB_clip01_autoW.%j.out
#SBATCH --error=bch_outs/vis2PM_RGB_clip01_autoW.%j.err
# kde 0 version
...
--type_whtL pwrs --kdeMode 0 --lambda_lap ${2} --lambda_sum 0 --lambda_ssim 0 --lambda_D 0 \
